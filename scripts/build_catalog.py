...
EXCLUDE = [
    ...
    r"発売開始", r"プレゼント", r"ポケモン", r"靴下", r"マット", r"特別取材", r"潜入",
    r"大感謝", r"YouTuberになった理由", r"無印良品", r"ほぐしテトラ", r"ランキング", r"買ってよかった",
    r"コンプレフロス", r"ついにやりました", r"コンビニ", r"靴の選び方", r"カラダのプロ",
    r"してみた結果",
]
...
RULES = [
    ...
    ("スポーツ・運動前後", r"運動前|運動後|クールダウン|ウォーミングアップ|ランニング|ウォーキング|サッカー|野球|テニス|バレー|バスケ|ゴルフ|登山|トレッキング|部活|足を速く|ロングスロー"),
    ("全身",           r"全身|体を柔らかく|ガチガチな体|本気の[0-9０-９]+分|親子でできる"),
    ("朝",             r"朝|Morning|モーニング"),
    ("夜・寝る前",     r"夜|寝る前|睡眠|快眠|熟睡|眠り|不眠|お風呂上がり|お風呂上がり|毎晩|ナイトルーティーン|Night"),
    ("座ったまま",     r"座ったまま|座りながら|椅子|イス|デスクワーク|授業中"),
    ("自律神経",       r"自律神経|リラックス|呼吸|ストレス|イライラ|生理|眠い|目を覚ます|集中力|覚醒"),
    ("生活・セルフケア", r"冷え症|足がつる|親指|スマホ依存|身長を伸ば|身長を高く|継続できない|やる気でない"),
    ("解説",           r"解説|秘密|目的|重心|効果|知らない|本当に柔らかく|本当に体を変えたい|症状別"),
]
