...
const C="kyono-v50";
const ASSETS=["./","index.html","videos.js","app-search.js","obu-feed.js","soudan-kb.js","app-quiz.js","app-record.js","app-card.js","manifest.json","assets/chara.png","assets/chara-good.png","assets/chara-kaikyaku.png","assets/chara-cardtour.png","assets/chara-2.png","assets/chara-3.png","assets/chara-cheer.png","assets/chara-crown.png","assets/obu-fab-photo.jpg","assets/check/q1.jpg","assets/check/q2.jpg","assets/check/meter.jpg","assets/icon-192.png","assets/icon-512.png","assets/icon-180.png","assets/fonts/banana-card.woff2?v=2","assets/type-momo.png","assets/type-kenko.png","assets/type-yawara.png","assets/pl-asa30.jpg","assets/pl-yoru30.jpg","assets/pl-suwatta20.jpg","assets/pl-zenshin35.jpg","assets/pl-jiritsu30.jpg","assets/pl-katakori30.jpg","assets/pl-koukansetsu30.jpg","assets/pl-youtsuu30.jpg","assets/chara-cracker.png","assets/chara-congrats.png","assets/chara-hitokoto.png","assets/ogp-card.png"];
// シェル（app本体）は必須=addAll、画像などはベストエフォート（1枚の失敗でオフライン対応全体を失わない）
// assets/obu/ 配下（写真・音声）は将来ファイルが増える想定のため事前キャッシュ対象に含めない
const SHELL=["./","index.html","videos.js","app-search.js","obu-feed.js","soudan-kb.js","app-quiz.js","app-record.js","app-card.js","manifest.json"];
...
self.addEventListener("fetch",e=>{
  ...
  const isShell=(e.request.mode==="navigate"||u.pathname.endsWith("videos.js")||u.pathname.endsWith("app-search.js")||u.pathname.endsWith("obu-feed.js")||u.pathname.endsWith("soudan-kb.js")||u.pathname.endsWith("app-quiz.js")||u.pathname.endsWith("app-record.js")||u.pathname.endsWith("app-card.js")||u.pathname.endsWith("index.html"));
