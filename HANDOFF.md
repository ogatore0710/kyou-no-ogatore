...
- `npm test` = **281 checks PASS**、`npm run smoke` = **25/25 PASS**、`npm run smoke:webkit` = **9/9 PASS**（puppeteer-core・ヘッドレスChrome/playwright-core・WebKit、オフライン動作・モーダルのフォーカス管理まで実機相当で自動確認）
