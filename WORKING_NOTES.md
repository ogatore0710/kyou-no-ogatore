...
- **最新: ビルド17配信済み（2026-08-03・version17/VALID/グループ紐付け・whatsNew設定までASC実照会で裏取り済み）**。中身=本人のビルド16実機フィードバック13件（`TASK-C2-2026-08-02-build17-feedback-fixes.md`）: P-1〜P-7修正＋Q-1〜Q-4（ツアー内かたさチェックを本物フル結果に格上げ・練習ポップアップ廃止・サムネはツアー中不可のまま=本人カード裁定）。
