...
// TASK-C2-2026-08-01-build14-fixes-and-5lens-audit.md A-4: 旧実装はここを常時0x3A3A35の
// 固定墨色でストロークしており、ダーク背景(0x211E19)とのコントラストがほぼ無く
// (使い方タブ・マイ記録タブのアイコンが軒並み消える)、タブバーで既に直した
// tabbarStrokeOffと同じ欠落だった。KyonoIconGlyph内で`colors.ink`(テーマ変数)を
// 直接使うよう全箇所置き換える(下記参照)。
    ...
    var body: some View {
        Canvas { ctx, size in
            ...
            case .clock:
                ...
                ctx.stroke(circle, with: .color(colors.ink), lineWidth: 2.2 * s)
                var hand = Path()
                hand.move(to: pt(12, 7.5)); hand.addLine(to: pt(12, 12)); hand.addLine(to: pt(15, 14.5))
                ctx.stroke(hand, with: .color(colors.ink), style: StrokeStyle(lineWidth: 2.2 * s, lineCap: .round))
            case .question:
                let circle = Path(ellipseIn: CGRect(x: 3.5 * s, y: 3.5 * s, width: 17 * s, height: 17 * s))
                ctx.fill(circle, with: .color(fill))
                ctx.stroke(circle, with: .color(colors.ink), lineWidth: 2.2 * s)
                ...
                ctx.stroke(q, with: .color(colors.ink), style: StrokeStyle(lineWidth: 2.2 * s, lineCap: .round))
                ctx.fill(Path(ellipseIn: CGRect(x: 11.7 * s, y: 16.7 * s, width: 0.6 * s, height: 0.6 * s)), with: .color(colors.ink))
            case .quizCheck:
                ...
                ctx.stroke(handle, with: .color(colors.ink), style: StrokeStyle(lineWidth: 2.2 * s, lineCap: .round))
                var cross = Path()
            ...
            case .soudanBubble, .obuBubble:
                ...
                ctx.stroke(bubble, with: .color(colors.ink), style: StrokeStyle(lineWidth: 2.2 * s, lineJoin: .round))
            ...
            case .play:
                ...
                ctx.stroke(rect, with: .color(colors.ink), lineWidth: 2.2 * s)
                var tri = Path()
            ...
            case .calendarCheck:
                ...
                ctx.stroke(lines, with: .color(colors.ink), style: StrokeStyle(lineWidth: 2.2 * s, lineCap: .round))
                var check = Path()
            ...
            case .envelope:
                ...
                ctx.stroke(chevron, with: .color(colors.ink), style: StrokeStyle(lineWidth: 2.2 * s, lineCap: .round, lineJoin: .round))
            case .notes:
            ...
            case .mountainCheck:
                ...
                ctx.stroke(mountain, with: .color(colors.ink), style: StrokeStyle(lineWidth: 2.2 * s, lineJoin: .round))
                var check = Path()
                ...
                ctx.stroke(check, with: .color(colors.ink), style: StrokeStyle(lineWidth: 2.2 * s, lineCap: .round))
            case .shieldCheck:
                var shield = Path()
                ...
                ctx.stroke(shield, with: .color(colors.ink), style: StrokeStyle(lineWidth: 2.2 * s, lineJoin: .round))
                var check = Path()
            ...
            case .star:
                ...
                ctx.stroke(star, with: .color(colors.ink), style: StrokeStyle(lineWidth: 1.6 * s, lineJoin: .round))
            case .search:
                let circle = Path(ellipseIn: CGRect(x: 4 * s, y: 4 * s, width: 13 * s, height: 13 * s))
                ctx.fill(circle, with: .color(fill))
                ctx.stroke(circle, with: .color(colors.ink), lineWidth: 2.2 * s)
            ...
            case .exportBox:
                ...
                ctx.stroke(flap, with: .color(colors.ink), style: StrokeStyle(lineWidth: 2.2 * s, lineCap: .round, lineJoin: .round))
                var tape = Path()
            ...
            case .clipboardPaste:
                ...
                ctx.stroke(board, with: .color(colors.ink), lineWidth: 2.2 * s)
                let clip = Path(roundedRect: CGRect(x: 9 * s, y: 3 * s, width: 6 * s, height: 3 * s), cornerRadius: 1.2 * s)
                ctx.fill(clip, with: .color(colors.ink))
                var lines = Path()
            ...
            case .importTray:
                ...
                ctx.stroke(tray, with: .color(colors.ink), style: StrokeStyle(lineWidth: 2.2 * s, lineJoin: .round))
                var shaft = Path()
                shaft.move(to: pt(12, 3)); shaft.addLine(to: pt(12, 12))
                ctx.stroke(shaft, with: .color(colors.ink), style: StrokeStyle(lineWidth: 2.2 * s, lineCap: .round))
                var head = Path()
            ...
            case .crownBadge:
                ...
                ctx.stroke(crown, with: .color(colors.ink), style: StrokeStyle(lineWidth: 2.2 * s, lineJoin: .round))
                var band = Path()
                band.move(to: pt(4, 17)); band.addLine(to: pt(20, 17))
                ctx.stroke(band, with: .color(colors.ink), style: StrokeStyle(lineWidth: 2.2 * s, lineCap: .round))
            ...
            case .confettiBurst:
                ...
                ctx.stroke(hornStroke, with: .color(colors.ink), style: StrokeStyle(lineWidth: 2.2 * s, lineCap: .round, lineJoin: .round))
            ...
            case .ticketStub:
                ...
                ctx.stroke(ticket, with: .color(colors.ink), style: StrokeStyle(lineWidth: 2.2 * s, lineJoin: .round))
                var perf = Path()
            ...
            case .goalFlag:
                ...
                ctx.stroke(pole, with: .color(colors.ink), style: StrokeStyle(lineWidth: 2.2 * s, lineCap: .round))
                var flag = Path()
                flag.move(to: pt(6, 4)); flag.addLine(to: pt(18, 7.5)); flag.addLine(to: pt(6, 11)); flag.closeSubpath()
                ctx.fill(flag, with: .color(accent))
                ctx.stroke(flag, with: .color(colors.ink), style: StrokeStyle(lineWidth: 2.2 * s, lineJoin: .round))
            case .sprout:
                var stem = Path()
                stem.move(to: pt(12, 20)); stem.addLine(to: pt(12, 12))
                ctx.stroke(stem, with: .color(colors.ink), style: StrokeStyle(lineWidth: 2.2 * s, lineCap: .round))
                var leftLeaf = Path()
                ...
                ctx.stroke(leftLeaf, with: .color(colors.ink), style: StrokeStyle(lineWidth: 2.2 * s, lineJoin: .round))
                var rightLeaf = Path()
                ...
                ctx.stroke(rightLeaf, with: .color(colors.ink), style: StrokeStyle(lineWidth: 2.2 * s, lineJoin: .round))
            case .hourglassTime:
                var top = Path()
                top.move(to: pt(6, 4)); top.addLine(to: pt(18, 4)); top.addLine(to: pt(12, 11)); top.closeSubpath()
                ctx.fill(top, with: .color(fill))
                ctx.stroke(top, with: .color(colors.ink), style: StrokeStyle(lineWidth: 2.2 * s, lineJoin: .round))
                var bottom = Path()
                ...
                ctx.stroke(bottom, with: .color(colors.ink), style: StrokeStyle(lineWidth: 2.2 * s, lineJoin: .round))
            ...
            case .phoneDevice:
                ...
                ctx.stroke(body, with: .color(colors.ink), lineWidth: 2.2 * s)
                var speaker = Path()
                speaker.move(to: pt(10, 5.5)); speaker.addLine(to: pt(14, 5.5))
                ctx.stroke(speaker, with: .color(colors.ink), style: StrokeStyle(lineWidth: 2.2 * s, lineCap: .round))
                var homeLine = Path()
            ...
            case .paletteArt:
                ...
                ctx.stroke(Path(ellipseIn: CGRect(x: 3 * s, y: 6 * s, width: 16 * s, height: 12 * s)), with: .color(colors.ink), lineWidth: 2.2 * s)
                ctx.stroke(Path(ellipseIn: CGRect(x: 5.2 * s, y: 13.2 * s, width: 3.6 * s, height: 3.6 * s)), with: .color(colors.ink), lineWidth: 2.2 * s)
            ...
            case .segSun:
                ...
                ctx.stroke(rays, with: .color(colors.ink), style: StrokeStyle(lineWidth: 2.2 * s, lineCap: .round))
            ...
            case .segMoon:
                ...
                ctx.drawLayer { layer in
                    layer.stroke(big, with: .color(colors.ink), lineWidth: 2.2 * s)
                    layer.blendMode = .destinationOut
                    layer.fill(small, with: .color(.black))
                }
                ...
                ctx.drawLayer { layer in
                    layer.clip(to: big)
                    layer.stroke(small, with: .color(colors.ink), lineWidth: 2.2 * s)
                }
            }
        }
    }
