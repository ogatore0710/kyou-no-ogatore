    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            KyonoCard {
                ...
                Text("つづいている日数").font(.system(size: 13, weight: .black)).foregroundColor(colors.sub)
                ...
                Spacer().frame(height: 14)
                Text("すきな1本をさがす🎬").font(.system(size: 13, weight: .black)).foregroundColor(colors.sub)
                Spacer().frame(height: 6)
                ...
                Spacer().frame(height: 8)
                Text("えらんだ1本").font(.system(size: 13, weight: .black)).foregroundColor(colors.sub)
                ...
                Spacer().frame(height: 8)
                Text("えらんだ1本は カードにサムネイル画像で入ります").font(.system(size: 13)).foregroundColor(colors.sub)
            }
        }
        .padding(16)
